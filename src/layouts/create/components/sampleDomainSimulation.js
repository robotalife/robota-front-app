...
export function initLocalFileLoader(simulationFile) {
  const exampleContainer = document.querySelector('#simulator');
  ...
  //const fileInput = document.querySelector('input#domain-file');
