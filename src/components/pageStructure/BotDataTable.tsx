      ...
      <Table>
        <TableBody>
              ...
              {botData.strategy === 'LONG' ? (
                <>
                  <TextBadge variation={'primary'}>
                    Long <IconArrowUpRight style={{ marginLeft: 10, height: 8, width: 8 }} />
                  </TextBadge>
                </>
              ) : (
                <>
                  <TextBadge variation={'primary'}>
                    Short <IconArrowDownRight style={{ marginLeft: 10, height: 8, width: 8 }} />
                  </TextBadge>
                </>
              )}
            </TableCell>
          ...
          <TableRow>
            ...
            <TableCell sx={{ textAlign: 'end' }}>
              <Typography className={classes.values}>{botData.leverageValue}</Typography>
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
            ...
            <TableCell sx={{ textAlign: 'end' }} className={classes.values}>
              {botData.marginType}
            </TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell sx={{ textAlign: 'end' }}>
              <Typography className={classes.values}>{getDateTimeString(botData.createdAt)}</Typography>
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
            ...
            <TableCell sx={{ textAlign: 'end' }}>
              <Typography className={classes.values}>{getDateTimeString(botData.startedAt)}</Typography>
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
