...
const RangePicker = ({ value, onChange, ...props }: Props) => {
  const handleChange = (newValue: Date | string | [Date | null, Date | null] | null) => {
  ...
  return (
    <div className={classes.pickerWrapper}>
      <DateRangePicker onChange={handleChange} value={value as [Date, Date]} clearIcon={null} format={'yyyy-MM-dd'} {...props} />
    </div>
  );
};
