...
import { IconCopy, IconInfoCircle, IconPause, IconPlay, IconVrHeadset } from '../icons/Icons';
...
const InnerStoreLayout = () => {
  ...
  const pageTitle = storeTabs(botId).find((link) => pathname === link.to)?.label || '';
      ...
      <PageTitle title={pageTitle}>
        <Grid container spacing={2} alignItems={'center'}>
          ...
          <Grid item xs={6} lg={'auto'}>
            <Button variant="contained" color="primary" size="small" sx={{ mb: { xs: 2, lg: 0 } }} fullWidth disabled={loading} onClick={() => {}}>
