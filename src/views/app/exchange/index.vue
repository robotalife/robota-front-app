    ...
    <b-row>
      <b-colxx xxs="12">
        ...
        <b-card class="mb-4" :title="$t('pages.myexchanges')">
          <router-link :to="{name: 'exchangeAdd'}" class="btn btn-dark float-right mb-3" style="margin-top:-50px">Add
            New Exchange
          </router-link>
        ...
        >
          <form ref="form" @submit.stop.prevent="deleteExchange">
            <span>To confirm you are deleting an exchange from your account, you need to enter the name of exchange in the following input (<b>{{
