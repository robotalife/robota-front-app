...
const NewBotOverview = () => {
    ...
    const [overview, setOverview] = useState<IBotOverviewV2>({
        ...
        lockedAsset: {value: '', symbol: ''},
        activeTradesTotalUpnl: {value: '', symbol: ''},
    ...
    const [activeButton, setActiveButton] = useState<'roi' | 'pnl'>('roi');
    ...
    const getOverviewData = useCallback(async () => {
        ...
        try {
            const response: AxiosResponse<IBotOverviewV2, any> = await axios.get(`${apiEndPoints.getBotOverview2(botId as string)}${duration}`);
            ...
            setChartInput(activeButton === 'roi' ? overview.roiChartData : overview.pnlCumulativeChartData);
        } catch (error) {
            // Handle error
        } finally {
            setLoading(false);
                                    ...
                                    <Table className={classes.table}>
                                        <TableBody>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell sx={{textAlign: 'end'}}>
                                                    <TextBadge>{overview.roi.value + overview.roi.symbol}</TextBadge>
                                                    {/* <Typography */}
                                                    {/*    component={"span"} */}
                                                    {/* > */}
                                            ...
                                            {/* </TableRow> */}
                                             <TableRow>
                                                ...
                                                >
                                                    {overview.activeTradesTotalUpnl.symbol + ' ' + overview.activeTradesTotalUpnl.value}
                                            ...
                                            <TableRow>
                                                <TableCell>
                                                    <Typography component={'span'}>Invested money on bot</Typography>
                                                </TableCell>
                                                <TableCell sx={{textAlign: 'end'}}>
                                            ...
                                            <TableRow>
                                                <TableCell><Typography component={"span"}>Funds locked in bot
                                                    trades</Typography></TableCell>
                                                <TableCell sx={{textAlign: "end"}}>
                                                    <Typography
                                                        component={"span"} className={classes.overviewValue}
                                                    > {overview.lockedAsset.symbol + ' ' + overview.lockedAsset.value}
                                                    </Typography>
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell>
                                                    <Typography component={'span'}>Total Transactions</Typography>
                                                </TableCell>
                                                <TableCell sx={{textAlign: 'end'}}>
                                                    <Typography component={'span'} className={classes.overviewValue}>
                                            ...
                                            <TableRow>
                                                <TableCell>
                                                    <Typography component={'span'}>No. of Winning Trades</Typography>
                                                </TableCell>
                                                <TableCell sx={{textAlign: 'end'}}>
                                                    {' '}
                                                    <Typography component={'span'} className={classes.overviewValue}>
                                            ...
                                            <TableRow>
                                                <TableCell>
                                                    <Typography component={'span'}>No. of Losing Trades</Typography>
                                                </TableCell>
                                                <TableCell sx={{textAlign: 'end'}}>
                                                    <Typography component={'span'} className={classes.overviewValue}>
                        ...
                        <WrapperBoxSection>
                            <Grid container justifyContent={'space-between'} alignItems={'center'} sx={{mb: 3}}>
                                ...
                                <Grid item xs={12} sx={{mb: 2, display: {lg: 'none'}}}>
                                    <Select onChange={(e) => setActiveButton(e.target.value as 'roi' | 'pnl')}
                                            value={activeButton} sx={{width: '100%'}}>
